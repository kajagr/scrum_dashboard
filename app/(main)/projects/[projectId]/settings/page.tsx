...
//               required
//               className="w-full rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary"
//               style={{
//                 border: "1px solid var(--color-border)",
...
//               rows={3}
//               className="w-full rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary resize-none"
//               style={{
//                 border: "1px solid var(--color-border)",
//                 background: "var(--color-background)",
//                 color: "var(--color-foreground)",
