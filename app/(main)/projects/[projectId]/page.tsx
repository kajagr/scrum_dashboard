    ...
    <div className="p-6 text-foreground">
      ...
      <div className="mb-8 grid grid-cols-2 gap-4 md:grid-cols-4">
        <div className="rounded-xl p-5 border border-border bg-surface">
          <p className="text-xs font-semibold tracking-widest uppercase text-muted mb-2">User Stories</p>
          <p className="text-2xl font-bold text-foreground">{storiesCount ?? 0}</p>
          <p className="text-xs text-subtle mt-0.5">{doneStoriesCount ?? 0} completed</p>
        </div>
        <div className="rounded-xl p-5 border border-border bg-surface">
          <p className="text-xs font-semibold tracking-widest uppercase text-muted mb-2">Sprints</p>
          <p className="text-2xl font-bold text-foreground">{sprintsCount ?? 0}</p>
          <p className="text-xs text-subtle mt-0.5">total sprints</p>
        </div>
        <div className="rounded-xl p-5 border border-border bg-surface">
          <p className="text-xs font-semibold tracking-widest uppercase text-muted mb-2">Team</p>
          <p className="text-2xl font-bold text-foreground">{membersCount ?? 0}</p>
          <p className="text-xs text-subtle mt-0.5">members</p>
        </div>
        <div className="rounded-xl p-5 border border-border bg-surface">
          <p className="text-xs font-semibold tracking-widest uppercase text-muted mb-2">Progress</p>
